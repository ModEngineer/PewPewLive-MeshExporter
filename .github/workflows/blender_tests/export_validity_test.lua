...
if arg[1]=="0" then
   ...
   if (cmpr_meshes(test_meshes[1], baseline_meshes[1]) or cmpr_meshes(test_meshes[1], baseline_meshes[2])) and (cmpr_meshes(test_meshes[2], baseline_meshes[1]) or cmpr_meshes(test_meshes[2], baseline_meshes[2])) then
      os.exit(0)
   else
      os.exit(1)
   end
